...
// let angulo=Number(prompt("ingresa la nota"));
// let edad = 20;
...
// const nombre=["pepe","juan","marias"];
// const data=[1,true,false,-2,"holamundo"];
...
// const colores=["rojo","verde","amarillo","azul","verde"];
// // ! es caseSensitive  respeta los  si ños datos estan en masucula o miniscula

// console.log(colores.indexOf("verde"));
// const bus=prompt("ingrese el color")
// if(colores.indexOf(bus)!==-1){
//     alert("el colo si existe y es "+colores.indexOf(bus))
// }
// else{
//     alert("el color no exite")
// }