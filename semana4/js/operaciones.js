...
const base=Number(prompt("indique la base"))
const altura=Number(prompt("indique la altura"))

console.log("la area es  :",base*altura)

const radio=Number(prompt("indique el radio"))
console.log("la areas es :",Math.PI*Math.pow(radio,2))
